...
public class BeachBonanzaWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BeachBonanzaWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BeachBonanzaWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BeachBonanzaWLAIW/InitOutcome.xml").getDocumentElement();
